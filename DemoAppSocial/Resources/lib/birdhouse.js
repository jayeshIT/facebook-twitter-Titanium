...
function BirdHouse(params) {
	...
	function save_access_token() {
		...
		Ti.App.Properties.setString('ttimg', 'https://api.twitter.com/1.1/users/profile_image/' + cfg.screen_name);
	...
	function send_tweet(params, callback) {
		...
		api2('https://api.twitter.com/1.1/statuses/update.json?include_entities=1', 'POST', params, function(resp) {
			if (resp != false) {
				Titanium.API.info("abc:" + resp);
	...
	function get_tweets(params, callback) {
		...
		api("https://api.twitter.com/1.1/statuses/friends_timeline.json", "GET", params, function(tweets) {
			try {
